...
namespace Starter3D.Application.ui
{
  public class AirspacePopup : Popup
  {
    ...
    public AirspacePopup()
    {
      ...
      DependencyPropertyDescriptor descriptor = DependencyPropertyDescriptor.FromProperty(PlacementTargetProperty,
        typeof (AirspacePopup));
    ...
    private void OnPopupLoaded(object sender, RoutedEventArgs e)
    {
      ...
      if (Child != null)
      {
        Child.AddHandler(PreviewMouseLeftButtonDownEvent, new MouseButtonEventHandler(OnChildPreviewMouseLeftButtonDown),
          true);
      }
